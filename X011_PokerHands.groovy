...
println "Now you have entered five calid cards, I'll calculate your best hand"

suit1 = suit_position1
rank1 = rank_position1

suit2 = suit_position2
rank2 = rank_position2

suit3 = suit_position3
rank3 = rank_position3

suit4 = suit_position4
rank4 = rank_position4

suit5 = suit_position5
rank5 = rank_position5

println "Cards sorted by rank are " + suit1 + rank1 + " " + suit2 + rank2 + " " + suit3 + rank3 + " " + suit4 + rank4 + " " + suit5 + rank5
...
// work out Poker - 4 out of 5 cards have the same rank
//Possibilities are: R1 = R2 = R3 = R4 != R5 OR R1 = R2 = R3 != R4 = R5 etc

	if ((rank1 == rank2 && rank2 == rank3 && rank3 == rank4 && rank4 != rank5) || (rank1 == rank2 && rank2 == rank3 && rank3 != rank4 && rank4 == rank5) || (rank1 == rank2 && rank2 != rank3 && rank3 == rank4 && rank4 == rank5) || (rank1 != rank2 && rank2 == rank3 && rank3 == rank4 && rank4 == rank5)) {
	BestHand = "Poker Hands"
	println "Your best hand is: " + BestHand
	}

// work out a Full House (three of a kind plus two of a kind)
	if ((rank1 == rank2 && rank2 == rank3) && (rank4 == rank5)) || (rank2 == rank3 && rank3 == rank4) && rank1 == rank5) ||  


// work out a Flush (all cards share same suit but not consecutive)
